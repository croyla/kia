import{x as s,r as t,u as a,L as r}from"./index-54c7dfcc.js";import{i,S as m}from"./i18n-f2646e27.js";import{M as u}from"./index.modern-28228485.js";const n={en:`
# Help and Support
## Immediate help
...
`},l=()=>{const[e,o]=t.useState(a.getItem("lang")||r[0].code);return t.useEffect(()=>{a.setItem("lang",e),document.documentElement.setAttribute("lang",e),i.changeLanguage(e)},[e]),t.createElement(t.Fragment,null,t.createElement(m,{setLang:o}),t.createElement(u,null,n[e]||n.en))},c=s(document.getElementById("root"));c.render(t.createElement(l,null));
//# sourceMappingURL=help-support-90ea8e5d.js.map
